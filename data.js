...
export const ITEMS = [
  ...
  { id: "shower-filter", category: "bathroom", name: "샤워필터", icon: "🚿", cycleDays: 60 },
  { id: "razor", category: "bathroom", name: "면도기", icon: "🪒", cycleDays: 14 },
  { id: "shower-puff", category: "bathroom", name: "샤워볼", icon: "🧽", cycleDays: 30 },
  { id: "lens-case", category: "bathroom", name: "렌즈통", icon: "🥽", cycleDays: 30 },
  ...
  { id: "container-seal", category: "kitchen", name: "밀폐용기 고무패킹", icon: "🥡", cycleDays: 180 },
  ...
  // 개인관리
  { id: "comb", category: "personal", name: "빗", icon: "🪮", cycleDays: 180 },
  { id: "hairbrush", category: "personal", name: "헤어브러쉬", icon: "🖌️", cycleDays: 365 },
  { id: "curling-iron", category: "personal", name: "고데기", icon: "🔥", cycleDays: null },
  { id: "eye-drops", category: "personal", name: "인공눈물", icon: "💧", cycleDays: 30 },
  ...
  { id: "fridge-deodorizer", category: "appliance", name: "냉장고 탈취제", icon: "🧊", cycleDays: 90 },
  { id: "washer-filter", category: "appliance", name: "세탁기 필터", icon: "🌀", cycleDays: 90 },
  { id: "candle", category: "appliance", name: "향초", icon: "🕯️", cycleDays: null },
];
