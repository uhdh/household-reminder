...
const sampleTransactions: Txn[] = [
  { id: "demo-1", householdId: "demo", uploadId: "demo", personId: "husband", txnDate: "2026-07-31", txnTime: "09:00:00", txnType: "수입", category: "급여", subcategory: "미분류", description: "7월 급여", amount: "3500000.00", paymentMethod: "급여통장", stdCategory: "월급", included: true, isInternalTransfer: false, beneficiary: "husband", categoryLocked: false },
  { id: "demo-2", householdId: "demo", uploadId: "demo", personId: "husband", txnDate: "2026-07-31", txnTime: "14:20:00", txnType: "지출", category: "식비", subcategory: "마트", description: "주말 장보기", amount: "-80000.00", paymentMethod: "체크카드", stdCategory: "식비", included: true, isInternalTransfer: false, beneficiary: "joint", categoryLocked: false },
  { id: "demo-3", householdId: "demo", uploadId: "demo", personId: "wife", txnDate: "2026-07-30", txnTime: "18:30:00", txnType: "지출", category: "생활", subcategory: "편의점", description: "생활용품", amount: "-50000.00", paymentMethod: "신용카드", stdCategory: "생필품", included: true, isInternalTransfer: false, beneficiary: "wife", categoryLocked: false },
  { id: "demo-4", householdId: "demo", uploadId: "demo", personId: "wife", txnDate: "2026-07-29", txnTime: "11:00:00", txnType: "지출", category: "주거/통신", subcategory: "관리비", description: "관리비", amount: "-250000.00", paymentMethod: "자동이체", stdCategory: "주거/통신", included: true, isInternalTransfer: false, beneficiary: "joint", categoryLocked: false },
  { id: "demo-5", householdId: "demo", uploadId: "demo", personId: "husband", txnDate: "2026-07-28", txnTime: "08:15:00", txnType: "지출", category: "교통", subcategory: "대중교통", description: "대중교통", amount: "-20000.00", paymentMethod: "체크카드", stdCategory: "교통", included: true, isInternalTransfer: false, beneficiary: "husband", categoryLocked: false },
];
