...
describe("getActiveTransactions", () => {
  ...
  test("keeps old dates but uses only the newest upload for overlapping dates", async () => {
    ...
    await db.insert(uploads).values([
      { id: "00000000-0000-0000-0000-000000000001", householdId, personId: "wife", sourceFilename: "과거.xlsx", isActive: false, uploadedAt: new Date("2026-08-01") },
      { id: "00000000-0000-0000-0000-000000000002", householdId, personId: "wife", sourceFilename: "최신.xlsx", isActive: true, uploadedAt: new Date("2026-08-31") },
    ]);
    await db.insert(transactions).values([
      {
        id: "00000000-0000-0000-0000-000000000011", householdId, uploadId: "00000000-0000-0000-0000-000000000001",
        personId: "wife", txnDate: "2026-07-31", txnType: "지출", amount: "-1000", included: true,
        isInternalTransfer: false, beneficiary: "wife",
      },
      {
        id: "00000000-0000-0000-0000-000000000012", householdId, uploadId: "00000000-0000-0000-0000-000000000002",
        personId: "wife", txnDate: "2026-08-01", txnType: "지출", amount: "-2000", included: true,
        isInternalTransfer: false, beneficiary: "wife",
      },
      {
        id: "00000000-0000-0000-0000-000000000013", householdId, uploadId: "00000000-0000-0000-0000-000000000001",
